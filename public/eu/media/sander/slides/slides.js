...
*/					
            ...
            this._hide_buttons(this.current);
    },
		_loaded: function() {
    ...
    _buildPagination: function() {
		...
		_navigate: function( event, effect ) {
			...
			*/
			...
			if ( to == this.slides.length - 1 && !pagination ) {
                // SVN stop at last slide
            ...
            this._hide_buttons(to);
		},
        _hide_buttons: function (current) {
            if (current == 0) {
            ...
            if (current == this.total - 1 || current == -1) {
